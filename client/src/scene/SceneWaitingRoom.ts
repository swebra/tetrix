...
export class SceneWaitingRoom extends Phaser.Scene {
    ...
    create() {
        ...
        this.button = this.add.text(BOARD_SIZE * 6.6, BOARD_SIZE * 9, "> Join <", { fontSize: "82px", fontFamily: "VT323" })
            .setTint(0x53bb74)
        ...
        this.playersNeededText = this.add.text(BOARD_SIZE * 6.9, BOARD_SIZE * 12, "Waiting on 4 more player(s)", { fontSize: "22px", fontFamily: "VT323" })
            .setTint(0x32a4a8);
